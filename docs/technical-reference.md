...
- [`docs/release.md`](release.md) defines deterministic, manual Semantic Versioning and release checks. No automatic credential-bearing release pipeline is included.
- [`docs/awesome-azd.md`](awesome-azd.md) contains the current Awesome AZD prerequisite checklist and copy-ready submission fields. It does not submit externally.
